...
public class FillingAnArray
{
    ...
    static String[] d(String[] myStringArray) {
        int number = 5;
    ...
    static String[] s(String[] myStringArray) {
